...
const cardFormSchema = z.object({
  ...
  number: z
    .string()
    .max(16, "กรุณากรอกข้อมูลให้ถูกต้อง")
    .min(16, "กรุณากรอกข้อมูลให้ครบถ้วน"),
  year: z
    .string()
    .min(4, "กรุณากรอกข้อมูลกรุณากรอกข้อมูลให้ครบถ้วน")
    .max(4, "กรุณากรอกข้อมูลกรุณากรอกข้อมูลให้ถูกต้อง"),
  month: z
    .string()
    .min(2, "กรุณากรอกข้อมูลกรุณากรอกข้อมูลให้ครบถ้วน")
    .max(2, "กรุณากรอกข้อมูลกรุณากรอกข้อมูลให้ถูกต้อง"),
  cvv: z
    .string()
    .min(3, "กรุณากรอกข้อมูลกรุณากรอกข้อมูลให้ครบถ้วน")
    .max(3, "กรุณากรอกข้อมูลกรุณากรอกข้อมูลให้ถูกต้อง"),
});
